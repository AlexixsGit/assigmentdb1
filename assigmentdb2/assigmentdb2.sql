...
--TRIGGER FOR INSERT INVOICES
CREATE or REPLACE TRIGGER INSERT_INVOICE_DETAIL 
    
    AFTER INSERT OF I.ID
    ON INVOICE I
    FOR EACH ROW 
BEGIN 
DECLARE
    ...
    SELECT TIV.VEHICLE_FOR_SALE_ID INTO VFS_ID FROM TRADE_IN_VEHICLES TIV WHERE TIV.ID = I.TRADE_IN_VEHICLE_ID;
        
    SELECT ACC.SELLING_PRICE + I.LICENSE_FEES + I.PLUS + I.TAXES INTO FINAL_PRICE
    FROM ACCESORIES ACC
    WHERE ACC.ID = 10;--DEBE SER UN ID RANDOM
    
    SELECT ACC.SELLING_PRICE INTO COSTO_DETAIL
    FROM ACCESORIES ACC
    WHERE ACC.ID = 10;--DEBE SER UN ID RANDOM
    
    UPDATE INVOICE NI SET NI.VEHICLE_FOR_SALE_ID = VFS_ID WHERE NI.ID = :new.INVOICE_ID;
    UPDATE INVOICE NI SET NI.FINAL_PRICE = FINAL_PRICE WHERE NI.ID = :new.INVOICE_ID;
        
    INSERT INTO INVOICE_DETAIL 
    VALUES 
        (INVOICE_DETAIL_SEQ.NEXTVAL,
         :new.INVOICE_ID, 
         ID_ACC, 
         COSTO_DETAIL); 
END; 
...
/*INVOICE*/
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,1,1,1,85701,87074,149331,1,23);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,7,1,1,87414,88144,180649,5,11);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,16,1,1,70712,69740,104794,3,39);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,9,1,1,88883,91042,158846,3,37);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,17,1,1,58436,56525,121061,3,9);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,13,1,1,59745,87311,108613,4,14);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,12,1,1,57998,63623,157697,1,22);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,13,1,1,64332,72686,125747,2,9);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,8,1,1,72324,86107,174198,3,14);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,11,1,1,54045,53923,170920,5,14);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,14,1,1,79635,54858,156992,5,31);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,4,1,1,88429,56701,126147,3,25);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,9,1,1,73460,69381,187647,5,11);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,20,1,1,59106,92415,143983,5,6);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,1,1,1,59544,92613,190807,1,45);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,13,1,1,77204,80336,114708,5,51);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,14,1,1,89299,64378,172611,2,47);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,15,1,1,97011,78993,130192,1,33);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,6,1,1,71408,91157,185265,4,47);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,5,1,1,53015,89811,134284,3,23);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,12,1,1,74888,92281,157422,1,47);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,9,1,1,99580,66800,101855,2,9);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,5,1,1,63788,89714,186862,1,15);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,3,1,1,71475,87201,183947,4,19);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,10,1,1,90983,79270,150175,3,47);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,6,1,1,52369,90434,130705,3,7);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,14,1,1,79929,99626,186775,3,30);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,15,1,1,77636,76901,109126,3,2);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,3,1,1,55262,94708,190356,4,18);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,12,1,1,91802,91087,116085,3,25);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,4,1,1,65112,65139,156966,1,37);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,4,1,1,54694,97808,120697,5,8);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,11,1,1,98381,97807,128092,3,30);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,16,1,1,52363,74005,131568,5,24);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,10,1,1,96789,77839,129032,3,24);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,4,1,1,53404,84313,151212,3,20);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,10,1,1,83545,96791,178540,5,33);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,11,1,1,83026,98724,143510,3,14);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,20,1,1,62334,88981,106356,4,30);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,13,1,1,94265,51238,135437,3,1);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,14,1,1,88045,55587,100417,2,30);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,4,1,1,94885,93475,144266,3,33);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,16,1,1,68861,57657,127111,3,43);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,15,1,1,84327,74736,106635,3,45);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,1,1,1,75547,96841,103574,1,51);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,13,1,1,82280,82892,144525,1,28);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,15,1,1,54849,65511,171927,4,27);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,12,1,1,74256,82369,102492,4,27);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,7,1,1,99671,53880,173153,5,1);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,8,1,1,81385,93391,137608,4,20);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,1,1,1,98198,66226,137792,5,37);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,2,1,1,50021,53257,193350,5,23);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,9,1,1,98111,87731,122785,2,22);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,10,1,1,93738,86751,195944,4,28);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,14,1,1,73314,93516,183264,5,16);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,1,1,1,69329,69394,154828,1,28);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,6,1,1,99802,68481,125383,5,33);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,9,1,1,58775,53180,137018,2,40);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,2,1,1,89730,85784,135563,1,21);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,8,1,1,51727,75427,197538,2,27);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,4,1,1,72246,62777,188989,1,11);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,18,1,1,85253,53905,190150,1,36);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,1,1,1,56948,88320,129816,4,20);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,4,1,1,93653,98096,124733,5,50);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,18,1,1,79910,95984,133923,4,36);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,9,1,1,75878,95280,161838,3,36);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,12,1,1,58858,61718,160906,4,2);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,8,1,1,86514,54436,175003,3,3);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,13,1,1,98481,86655,118777,1,42);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,6,1,1,99074,86500,127693,2,5);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,5,1,1,60522,64984,138162,5,16);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,14,1,1,61229,69079,152410,3,3);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,14,1,1,99301,97162,188510,3,49);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,2,1,1,62249,93599,181367,4,46);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,15,1,1,70719,63470,133912,1,20);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,3,1,1,58600,76058,100680,2,45);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,17,1,1,58165,76594,121106,1,12);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,16,1,1,99470,97934,115908,2,13);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,10,1,1,69197,75243,184459,5,7);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,7,1,1,93283,64632,116330,4,16);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,15,1,1,81795,72458,147945,2,31);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,6,1,1,82566,67399,142944,4,33);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,20,1,1,68039,72980,177163,4,28);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,18,1,1,55368,98331,151047,5,32);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,10,1,1,64032,77469,120609,5,5);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,11,1,1,64449,52439,174561,5,39);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,4,1,1,55222,88092,107840,1,32);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,14,1,1,71736,81359,188423,2,7);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,4,1,1,94607,88438,119153,1,9);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,15,1,1,91878,56138,166840,3,31);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,5,1,1,51877,57948,169636,4,35);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,6,1,1,85443,89602,119373,3,3);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,16,1,1,84597,51661,147968,1,4);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,9,1,1,66899,91217,132065,4,28);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,1,1,1,97640,87908,191395,3,17);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,14,1,1,67211,73477,147175,5,22);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,18,1,1,83207,59508,168593,2,18);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,3,1,1,74706,66270,108950,2,19);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,1,1,1,97059,50780,129419,5,5);
INSERT INTO ACCESORIES_INVENTORY (id,CUSTOMER_ID,VEHICLE_FOR_SALE_ID,FINAL_PRICE,PLUS,TAXES,LICENSE_FEES,SALES_PERSON_ID,TRADE_IN_VEHICLE_ID) VALUES (INVOICE_SEQ.NEXTVAL,16,1,1,74249,64679,137973,5,8);

--Ejemplo de procedimiento
/*
CREATE OR REPLACE PROCEDURE "SALWEB"."SP_SLW_DEPURARMALLA" AS

  TYPE MATRIZ_ROWID IS TABLE OF ROWID;
  TYPE MATRIZ_COL1 IS TABLE OF AUT_TMPAUTORIZACIONES.CODIGOIPSEMITE%TYPE;
  TYPE MATRIZ_COL2 IS TABLE OF AUT_TMPAUTORIZACIONES.CODIGOORIGENAUTORIZACION%TYPE;
  TYPE MATRIZ_COL3 IS TABLE OF AUT_TMPAUTORIZACIONES.CODIGOTIPOPRESTACION%TYPE;
  TYPE MATRIZ_COL4 IS TABLE OF AUT_TMPAUTORIZACIONES.CONSECUTIVOAUTORIZACION%TYPE;
  ROW PLS_INTEGER;

  CURSOR DELETE_PROCEDIMIENTOS IS
    SELECT ROWID,
           CODIGOIPSEMITE,
           CODIGOORIGENAUTORIZACION,
           CODIGOTIPOPRESTACION,
           CONSECUTIVOAUTORIZACION
      FROM AUT_TMPAUTORIZACIONES A
     WHERE CODIGOERRORAUTORIZACION = 0
       AND CODIGOTIPOPRESTACION = 0
       AND CARGADASALUDWEB = 'S';

  CURSOR DELETE_MEDICAMENTOS IS
    SELECT ROWID,
           CODIGOIPSEMITE,
           CODIGOORIGENAUTORIZACION,
           CODIGOTIPOPRESTACION,
      ...
      FROM AUT_TMPAUTORIZACIONES A
     WHERE CODIGOERRORAUTORIZACION = 0
       AND CODIGOTIPOPRESTACION = 1
       AND CARGADASALUDWEB = 'S';

  CURSOR DELETE_ORDENES_PARCIALES IS
    SELECT ROWID,           
           CODIGOIPSEMITE,
           CODIGOORIGENAUTORIZACION,
           CODIGOTIPOPRESTACION,
           CONSECUTIVOAUTORIZACION
      FROM AUT_TMPAUTORIZACIONES
     WHERE CODIGOERRORAUTORIZACION = 44
       AND CODIGOTIPOPRESTACION = 0
       AND CARGADASALUDWEB = 'N'
       AND FECHAEMISION < SYSDATE - 180
       AND CDMEDIOPAGO IS NULL;
...
BEGIN
  OPEN DELETE_PROCEDIMIENTOS;
  LOOP
  
    FETCH DELETE_PROCEDIMIENTOS BULK COLLECT
      INTO M_ROWID, COL1, COL2, COL3, COL4 LIMIT 100;
  
    FORALL ROW IN 1 .. M_ROWID.COUNT()
      DELETE AUT_TMPPROCEDIMIENTOSXAUTORIZA
       WHERE CODIGOIPSEMITE = COL1(ROW)
         AND CODIGOORIGENAUTORIZACION = COL2(ROW)
         AND CODIGOTIPOPRESTACION = COL3(ROW)
         AND CONSECUTIVOAUTORIZACION = COL4(ROW);
  
    FORALL ROW IN 1 .. M_ROWID.COUNT()
      DELETE AUT_TMPAUTORIZACIONES WHERE ROWID = M_ROWID(ROW);
  
    COMMIT;
    EXIT WHEN DELETE_PROCEDIMIENTOS%NOTFOUND;
  END LOOP;
  CLOSE DELETE_PROCEDIMIENTOS;

  OPEN DELETE_MEDICAMENTOS;
  LOOP
  
    FETCH DELETE_MEDICAMENTOS BULK COLLECT
      INTO M_ROWID, COL1, COL2, COL3, COL4 LIMIT 100;
  
    FORALL ROW IN 1 .. M_ROWID.COUNT()
      DELETE AUT_TMPMEDICAMENTOSXAUTORIZA
       WHERE CODIGOIPSEMITE = COL1(ROW)
         AND CODIGOORIGENAUTORIZACION = COL2(ROW)
         AND CODIGOTIPOPRESTACION = COL3(ROW)
         AND CONSECUTIVOAUTORIZACION = COL4(ROW);
    ...
    COMMIT;
    EXIT WHEN DELETE_MEDICAMENTOS%NOTFOUND;
  END LOOP;
  CLOSE DELETE_MEDICAMENTOS;

  OPEN DELETE_ORDENES_PARCIALES;
  LOOP
  
    FETCH DELETE_ORDENES_PARCIALES BULK COLLECT
      INTO M_ROWID, COL1, COL2, COL3, COL4 LIMIT 100;
    ...
    COMMIT;
    EXIT WHEN DELETE_ORDENES_PARCIALES%NOTFOUND;
  END LOOP;
  CLOSE DELETE_ORDENES_PARCIALES;

END SP_SLW_DEPURARMALLA;
*/